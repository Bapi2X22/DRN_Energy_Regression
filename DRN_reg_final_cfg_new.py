...
jobid = os.environ.get('CRAB_JOBID', '0')  # '0' is a fallback default
...
#    fileName = cms.string('/eos/user/b/bbapi/Energy_regression/CMSSW_13_3_3/src/crab_files/skimmed'+'/'+ options.datasetname+'/'+infilename),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string(f'output_crab_{jobid}.root'),
    closeFileFast = cms.untracked.bool(True)
)
