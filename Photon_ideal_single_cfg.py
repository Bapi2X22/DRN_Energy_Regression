...
#       'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL18RECO/DoublePhoton_Pt-5To300-gun/AODSIM/FlatPU0to70EdalIdealGT_EdalIdealGT_106X_upgrade2018_realistic_v11_L1v1_EcalIdealIC-v2/130000/EFE5A23C-7B5C-CF48-B803-97E404663C12.root'
        'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL18RECO/DoublePhoton_Pt-5To300-gun/AODSIM/FlatPU0to70EdalIdealGT_EdalIdealGT_106X_upgrade2018_realistic_v11_L1v1_EcalIdealIC-v2/280000/D9404076-A6FD-EC48-97F7-7B20A36FCD27.root'    
),
...
#setupAllVIDIdsInModule(process, cutBasedPhotonID_Spring16_V2p2_ID, setupVIDPhotonSelection)
...
#        gsfElectronsDRN = cms.InputTag("gsfElectronsDRN"),
        ...
        #MVA Based Id
    eleLooseIdMap = cms.InputTag("RecoEgamma.PhotonIdentification.Identification.mvaPhotonID_Fall17_94X_V2_cff"),
        eleMediumIdMap = cms.InputTag("RecoEgamma.PhotonIdentification.Identification.mvaPhotonID_Fall17_94X_V2_cff"),
        eleTightIdMap = cms.InputTag("RecoEgamma.PhotonIdentification.Identification.mvaPhotonID_Fall17_94X_V2_cff")
        )
process.TFileService = cms.Service("TFileService",
#     fileName = cms.string('D3'+output),
     fileName = cms.string('D9404076-A6FD-EC48-97F7-7B20A36FCD27.root'),
